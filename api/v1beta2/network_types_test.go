...
func TestSubnetSpec_SetZoneInfo(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			zones: []*types.AvailabilityZone{
				{
					ZoneName: ptr.To("us-east-1b"),
					ZoneType: ptr.To("availability-zone"),
				},
				{
					ZoneName: ptr.To("us-east-1a"),
					ZoneType: ptr.To("availability-zone"),
				},
				{
					ZoneName: ptr.To("us-east-1-wl1-nyc-wlz-1"),
					ZoneType: ptr.To("wavelength-zone"),
				},
				{
					ZoneName: ptr.To("us-east-1-nyc-1a"),
